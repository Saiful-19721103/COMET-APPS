            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="counter">
                        ...
                        <div class="counter-content">
                            <h5><span data-count="212" class="number-count">212</span><span class="red-dot"></span></h5>
                            <span>Projects</span>
                        </div>
                    </div>
                    <!-- end of counter              -->
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="counter">
                        ...
                        <div class="counter-content">
                            <h5> <span data-count="9060" class="number-count">9060</span><span class="red-dot"></span></h5>
                            <span>Lines of
                                Code</span>
                        </div>
                    </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="counter">
                        ...
                        <div class="counter-content">
                            <h5><span data-count="75" class="number-count">75</span><span class="red-dot"></span></h5>
                            <span>Clients</span>
                        </div>
                    </div>
                    <!-- end of counter              -->
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="counter">
                        ...
                        <div class="counter-content">
                            <h5><span data-count="872" class="number-count">872</span><span class="red-dot"></span></h5>
                            <span>Tweets</span>
                        </div>
                    </div>
                    <!-- end of counter              -->
